...
export declare class Files extends APIResource {
     ...
     * ```
     */
    list(params?: FileListParams | null | undefined, options?: RequestOptions): PagePromise<BetaFileMetadataPage, BetaFileMetadata>;
    /**
     * Delete File
     *
     * @example
     ...
     * ```
     */
    delete(fileID: string, params?: FileDeleteParams | null | undefined, options?: RequestOptions): APIPromise<BetaDeletedFile>;
    /**
     * Download File
     *
     * @example
     ...
     * ```
     */
    retrieveMetadata(fileID: string, params?: FileRetrieveMetadataParams | null | undefined, options?: RequestOptions): APIPromise<BetaFileMetadata>;
    /**
     * Upload File
     *
     * @example
...
export declare namespace Files {
    export { type BetaDeletedFile as BetaDeletedFile, type BetaFileMetadata as BetaFileMetadata, type BetaFileScope as BetaFileScope, type BetaFileMetadataPage as BetaFileMetadataPage, type FileListParams as FileListParams, type FileDeleteParams as FileDeleteParams, type FileDownloadParams as FileDownloadParams, type FileRetrieveMetadataParams as FileRetrieveMetadataParams, type FileUploadParams as FileUploadParams, };
}
